...
class ProductsEndpointsTest(BaseTest):
    ...
    def test_add_product(self):
        ...
        self.assertIn('shirt', str(respons.data))
    ...
    def test_add_same_product(self):
        ...
        self.assertIn('product with name already exists', str(respons.data))
    ...
    def test_get_item_by_non_existing_id(self):
        ...
        self.assertIn('product with id 20 does not exist', str(respons.data))
    ...
    def test_get_item_by_str(self):
        ...
        self.assertIn('int type required', str(respons.data))
    ...
    def test_edit_product(self):
        response = self.client.post('/api/v1/products/1', 
                                    ...
                                    headers=self.admin_headers)
        self.assertEqual(response.status_code, 201)
        self.assertIn('vest', str(respons.data))
    ...
    def test_delete(self):
        ...
        self.assertIn('product deleted', str(respons.data))
